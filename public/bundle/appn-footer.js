import { r, _ as __esDecorate, a as __setFunctionName, b as __runInitializers, i, x, t } from './custom-element-T1yNbIOj.js';
 ...
 */
let AppnFooterElement = (() => {
    let _classDecorators = [t('appn-footer')];
    ...
    (class extends _classSuper {
        ...
        static styles = [
            i `:host{display:flex;flex-direction:column;padding-bottom:var(--safe-area-inset-bottom,0)}`,
            translucentStyle,
        ];
        render() {
